...
export default function Home() {
  ...
  const accesos = [
    { label: 'Recibos',    sub: 'Descargá tus recibos', path: '/recibos',  color: '#EEF2FF', icon: '📄' },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        {accesos.map((a) => (
          <button key={a.path} onClick={() => navigate(a.path)}
            style={{ background: a.color, border: '1px solid var(--color-border)', borderRadius: 'var(--radius-md)',
